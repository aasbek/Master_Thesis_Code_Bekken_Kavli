...
public class GurobiInterface_Heuristic {
	...
	public PathBuilder_Heuristic builder;
	...
	public GurobiInterface_Heuristic(InstanceData inputdata, Vector<Node> deliveryNodes, Vector<Node> pickupNodes, Vector<Vehicle> vehicles, Vector<Double> dualVisitedPickupsCon, Vector<Double> dualOneVisitCon, PrintWriter pw, PrintWriter fw) throws Exception {
	...
	public void initiateProblem() throws Exception {
		...
		builder = new PathBuilder_Heuristic(pickupNodes, deliveryNodes, inputdata, pw, vehicles);
